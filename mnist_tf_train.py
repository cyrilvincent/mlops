...
trained = model.fit(x_train, y_train, epochs=5, batch_size=1,validation_data=(x_test, y_test))
print(model.summary())

# MSE ytest=1 ypredict=2 (2-1)²=1
# MSE ytest=1 ypredict=9 (9-1)²=64
# Crossentropy ytest=1 ypredict=5 Erreur=1
# Crossentropy ytest=1 ypredict=0 Erreur=0
